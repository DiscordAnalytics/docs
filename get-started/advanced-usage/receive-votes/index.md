...
* Followed the tutorial [Votes Integration](/get-started/votes-integration)
* Have install [NodeJS](https://nodejs.org/en/download/) (tested with 20.10.0 version)
* Have a [registered bot on Discord Analytics](/get-started/bot-registration)
...
This app sample use NodeJS, so we need to install the dependencies:
...
Aside from these two constraints, you are free to do as you please, respecting our [Terms of Service](/legals/terms).
